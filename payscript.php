...
<?php
    $apiKey = "rzp_test_E9evOH0CdwsaEh";
?>
...
<form action="" method="POST">
    <script
        ...
        data-name="Nexus Coworking Solution"
        data-description=""
    ...
    <button type="submit" id="rzp-button1" style="display:none;">Pay with Razorpay</button>
</form>
<script type="text/javascript">
    $(document).ready(function(){
        $("#rzp-button1").click(); // auto click on the hidden button
    });
</script>